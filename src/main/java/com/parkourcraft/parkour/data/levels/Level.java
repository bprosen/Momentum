...
public class Level {
    ...
    private void load() {
        if (LevelsYAML.exists(name)) {
            ...
            if (dropperLevel)
                dropperRespawnY = LevelsYAML.getDropperRespawnY(name);
        }
    }
    ...
    public boolean hasDropperRespawnY() { return dropperRespawnY > -1; }

    public int getDropperRespawnY() { return dropperRespawnY; }
