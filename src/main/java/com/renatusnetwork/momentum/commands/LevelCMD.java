                    ...
                    if (level != null)
                    {
                        ...
                        if (blocks.size() == 2 && blocks.get(1).getType() != null && blocks.get(1).getType() != Material.AIR)
                        {
                            ...
                            if (face != BlockFace.DOWN && face != BlockFace.UP)
                            {
                                ...
                                // use config set
                                sign.setLine(0, Utils.translate("&1&l" + Momentum.getSettingsManager().signs_first_line));
                                sign.setLine(1, Utils.translate("&9" + Momentum.getSettingsManager().signs_second_line_completion));
