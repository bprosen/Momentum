            ...
            if (a.length == 0)
                ...
                if (a[0].equalsIgnoreCase("list")) { //subcommand: list
                    sender.sendMessage(Utils.translate("&7Locations: &2" + String.join("&7, &2",
                                       Momentum.getLocationManager().getNames())));
                    ...
                    if (sender instanceof Player) {
                        ...
                        if (a.length == 2) {
                            ...
                            if (Momentum.getLocationManager().exists(locationName)) {
                                Momentum.getLocationManager().teleport(player, locationName);
                    ...
                    if (sender instanceof Player) {
                        ...
                        if (a.length == 2) {
                            ...
                            Momentum.getLocationManager().save(locationName, playerLocation);
                    ...
                    Momentum.getConfigManager().load("locations");
                    ...
                    sender.sendMessage(Utils.translate("&7Loaded locations from &2locations.yml&7, &a" +
                            Momentum.getLocationManager().getNames().size() + " &7total"));
                } else {
