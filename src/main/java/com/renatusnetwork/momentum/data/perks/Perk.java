...
public class Perk {
    ...
    public ELOTier getRequiredELOTier() {
        return requiredELOTier;
    }
    ...
    public boolean alreadyRequiresLevel(Level level) {
        return requiredLevels.contains(level);
    }

    public void addRequiredLevel(Level level) {
        requiredLevels.add(level);
    }

    public void removeRequiredLevel(Level level) {
        requiredLevels.remove(level);
    }

    public void setRequiredLevels(List<Level> requiredLevels) {
        this.requiredLevels = requiredLevels;
    }

    public void addArmorItem(PerksArmorType type, ItemStack itemStack) {
        armorItems.put(type, itemStack);
    }

    public boolean hasArmorItem(PerksArmorType type) {
        return armorItems.containsKey(type);
    }

    public void setArmorItems(HashMap<PerksArmorType, ItemStack> armorItems) {
        this.armorItems = armorItems;
    }

    public ItemStack getArmorPiece(PerksArmorType type) {
        return armorItems.get(type);
    }

    public void removeArmorItem(PerksArmorType type) {
        armorItems.remove(type);
    }

    public void setArmorItem(PerksArmorType type, ItemStack item) {
        armorItems.replace(type, item);
    }

    public HashMap<PerksArmorType, ItemStack> getArmorItems() {
        return armorItems;
    }
    ...
    public void setRequiresMasteryLevels(boolean result) {
        this.requiresMasteryLevels = result;
    }

    public void toggleRequiresMasteryLevels() {
        requiresMasteryLevels = !requiresMasteryLevels;
    }

    public boolean requiresMasteryLevels() {
        return requiresMasteryLevels;
    }
