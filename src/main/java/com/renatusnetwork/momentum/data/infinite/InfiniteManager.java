...
import com.renatusnetwork.momentum.data.infinite.gamemode.*;
import com.renatusnetwork.momentum.data.leaderboards.InfiniteLB;
        ...
        if (player != null)
        {
            ...
            if (infinite != null)
            {
                ...
                if (!event.isCancelled())
                {
                    ...
                    Momentum.getLevelManager().regionLevelCheck(playerStats, player.getLocation());
