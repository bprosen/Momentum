...
import com.renatusnetwork.momentum.api.ClanXPRewardEvent;
...
public class ClansManager {
    ...
    private HashMap<Integer, Clan> clansLeaderboard = new HashMap<>(Momentum.getSettingsManager().max_clans_leaderboard_size);
    ...
    public void doClanXPCalc(Clan clan, Player player, Level level)
    {
        ...
        int min = Momentum.getSettingsManager().clan_calc_percent_min;
        int max = Momentum.getSettingsManager().clan_calc_percent_max;
        ...
        if (clan != null) {
            ...
            for (ClanMember clanMember : clan.getMembers()) {
                ...
                if (clanPlayer != null) {
                    ...
                    Momentum.getStatsManager().get(clanPlayer).resetClan();
                }
            }
