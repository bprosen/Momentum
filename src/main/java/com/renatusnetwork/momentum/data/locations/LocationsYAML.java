...
public class LocationsYAML {
    ...
    private static FileConfiguration locationsFile = Momentum.getConfigManager().get("locations");

    private static void commit(String locationName) {
        Momentum.getConfigManager().save("locations");
        Momentum.getLocationManager().load(locationName);
    }
