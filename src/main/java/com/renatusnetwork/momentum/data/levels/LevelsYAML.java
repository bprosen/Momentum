...
public class LevelsYAML {
    ...
    private static FileConfiguration levelsFile = Momentum.getConfigManager().get("levels");

    public static void commit(String levelName) {
        Momentum.getConfigManager().save("levels");
    ...
    public static Rank getRankRequired(String levelName)
    {
        ...
        if (isSet(levelName, "required_rank"))
            rank = Momentum.getRanksManager().get(levelsFile.getString(levelName + ".required_rank"));
