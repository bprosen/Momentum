...
public class LevelManager {
    ...
    public int getNumMasteryLevels() {
    ...
    public boolean isLoadingLeaderboards() {
        return loadingLeaderboards;
    }

    public void setLoadingLeaderboards(boolean loadingLeaderboards) {
        this.loadingLeaderboards = loadingLeaderboards;
    }
    ...
    public HashMap<Menu, Set<Level>> getMenuLevels() {
        return menuLevels;
    }
    ...
    public ArrayList<MenuItem> searchMenuLevelsIgnoreCase(String levelTitle) {
        ...
        int currentIndex = 0;
        outer:
        while (currentIndex < searchStrings.size()) {
    ...
    public long getTotalLevelCompletions() {
        return totalLevelCompletions;
    }

    public void removeTotalLevelCompletion() {
    ...
    public ArrayList<Level> getTopRatedLevelsLB() {
        return topRatedLevelsLB;
    }
    ...
    public ArrayList<RecordsLBPosition> getRecordsLB() {
        return recordsLB;
    }
