...
public class SavesDB
{
    ...
    {
        // add to async queue
        Momentum.getDatabaseManager().runAsyncQuery("INSERT INTO saves " +
    ...
    {
        Momentum.getDatabaseManager().runAsyncQuery("DELETE FROM saves WHERE uuid='" + playerStats.getUUID() + "' AND level_name='" + levelName + "'");
    }
}
