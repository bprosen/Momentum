                ...
                if (target != null)
                {
                    if (!user.getName().equalsIgnoreCase(target.getName()))
                    {
                        if (Utils.isInteger(a[1]))
                        {
                            ...
                            if (coins >= Parkour.getSettingsManager().minimum_pay_amount)
                            {
                            ...
                            {
                                user.sendMessage(Utils.translate("&cYou cannot pay less than &6" + Utils.formatNumber(Parkour.getSettingsManager().minimum_pay_amount) + " &eCoins"));
                            }
                        }
                        else
                        {
