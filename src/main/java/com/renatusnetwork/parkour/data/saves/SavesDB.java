...
public class SavesDB
{
    ...
    {
        // add to async queue
        Parkour.getDatabaseManager().add("INSERT INTO saves " +
    ...
    {
        Parkour.getDatabaseManager().add("DELETE FROM saves WHERE uuid='" + playerStats.getUUID() + "' AND level_name='" + levelName + "'");
    }
}
